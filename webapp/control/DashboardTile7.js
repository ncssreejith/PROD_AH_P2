sap.ui.define([
	 ...
	 *   Note : 
	 *************************************************************************** */
	return Control.extend("avmet.ah.control.Dashboard7", {
		metadata: {
			properties: {
				title: {
					type: "string",
		...
		renderer: function (oRM, oControl) {
			...
			oRM.write(">");
				...
				oRM.write("<div class='DBTile3Left'>");
					oRM.write("<div class='DBTile7LeftTitleDiv'>");
						oRM.write("<div class='DBTile7LeftInfo'>");
							oRM.write("<div");
			oRM.writeControlData(oControl);
			...
			oRM.renderControl(aChildren[0]);
							...
							oRM.write("</div>");
							oRM.write("<div class='DBTile7LeftInfoHeading'>");
							
								oRM.write(oControl.getLeftHeading());
							oRM.write("</div>");
							oRM.write("<div class='DBTile7LeftInfoSubHeading'>");
